    ...
    plan: {
      ...
      nutrition: { kcal: 3100, proteinG: 184, carbsG: 360, fatG: 86,
        meals: [
          ...
          { slot: "janta", title: "Janta", items: ["Macarrão + frango + legumes", "Peixe (170g) + purê (150g) + legumes"] },
        ], groceryList: [], notes: "" },
...
await page.type("textarea", "quero 6 exercicios por dia, eu aguento, pode confiar", { delay: 5 });
